...
class Serializable(ABC):
    ...
    def write_to_file(self, filepath: str, data_dict: Dict) -> None:
...
def generate_file_path(path: str, file_name: str, extension: str) -> str:
...
def read_from_file(filepath: str) -> Tuple[Any, Dict]:
