class Options:
    ...
    def __init__(self, fit_range_fraction=1.0, floquet_sampling_time_fraction=0.0, 
                 fit_cutoff=4, overlap_cutoff=0.8, nsteps=30000, num_cpus=1, 
                 save_floquet_modes=False):
        """Initialize an instance of the class with configurable parameters for fitting range, Floquet sampling, cutoffs, computational steps, CPU usage, and Floquet mode saving."""
